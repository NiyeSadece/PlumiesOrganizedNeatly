...
var shape_list = [17, 13, 13, 15]  # Replace with your shape identifiers
var shape_index = 0  # Track the current index of the shape to spawn
var empty_spots = [1, 4, 13, 15, 20]
...
func _on_restart_pressed():
	if not Global.popup26:
		Global.popup26 = true
	get_tree().change_scene_to_file("res://scenes/levels/level_26.tscn")

func _on_next_pressed():
	get_tree().change_scene_to_file("res://scenes/levels/level_27.tscn")

func _on_popup_button_pressed():
	$TextureRect2/Popup.visible = false
