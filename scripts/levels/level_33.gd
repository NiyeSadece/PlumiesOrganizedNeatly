...
var shape_list = [1, 10, 11, 15, 14, 16, 17, 15, 20, 21]  # Replace with your shape identifiers
var shape_index = 0  # Track the current index of the shape to spawn
var empty_spots = [0, 1, 2, 3, 4, 6, 7, 8, 12, 15, 20, 21, 23, 29, 52, 60, 63]
...
func _on_restart_pressed():
	if not Global.popup33:
		Global.popup33 = true
	get_tree().change_scene_to_file("res://scenes/levels/level_33.tscn")
