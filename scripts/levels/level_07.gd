...
var shape_list = [1, 2, 3, 5]  # Replace with your shape identifiers
var shape_index = 0  # Track the current index of the shape to spawn
var empty_spots = [8, 12, 13]
...
func _on_restart_pressed():
	if not Global.popup7:
		Global.popup7 = true
	get_tree().change_scene_to_file("res://scenes/levels/level_07.tscn")

func _on_next_pressed():
	get_tree().change_scene_to_file("res://scenes/levels/level_08.tscn")
