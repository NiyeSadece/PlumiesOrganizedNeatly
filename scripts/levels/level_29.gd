...
var shape_list = [2, 4, 5, 10, 13, 16, 17, 18]  # Replace with your shape identifiers
var shape_index = 0  # Track the current index of the shape to spawn
var empty_spots = [16, 17, 23, 24, 30, 31, 37, 38, 44, 45]
...
func _on_restart_pressed():
	if not Global.popup29:
		Global.popup29 = true
	get_tree().change_scene_to_file("res://scenes/levels/level_29.tscn")

func _on_next_pressed():
	get_tree().change_scene_to_file("res://scenes/levels/level_30.tscn")
